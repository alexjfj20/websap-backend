@echo off
REM Script para subir el backend a GitHub
echo ====================================================
echo    DESPLIEGUE A GITHUB - WEBSAP BACKEND
echo ====================================================

REM Navegamos al directorio del proyecto (ya estamos en él si ejecutamos desde aquí)
cd "c:\Users\Alexjf\websap-backend"
...
echo Render detectará los cambios y volverá a implementar automáticamente.
echo ====================================================
pause